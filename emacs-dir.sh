...
# --reverse-video fixes the issue with emacs starting on black background (todo: find a proper fix)
emacs --reverse-video -nw --no-desktop "$DIR_ONE" -f split-window-vertically "$DIR_TWO" -f other-window
